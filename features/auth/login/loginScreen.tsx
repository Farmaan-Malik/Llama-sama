      ...
      >
       <View style={styles.inner}>
        ...
        <LocalSvg.MediumCurve
          ...
          />
           <AnimatedTextBar
            titleStyle={[styles.title,{marginTop:(height ?? HEIGHT) * 0.65}]}
            text="Sign In"
          ...
          <View style={{marginTop:20}}></View>
           ...
           <View>
               ...
               <View style={styles.inputRow}>
                ...
                />
                {showPassword ?
                <Ionicons name='eye-outline' size={20} onPress={()=>setShowPassword(false)}/>
                :
                <Ionicons name='eye-off-outline' size={20} onPress={()=>setShowPassword(true)}/>
                }
              </View>
            </View>
        ...
        <View style={styles.footer}>
            ...
            <View style={styles.bottomRow}>
              ...
              <Text onPress={()=>router.navigate('/(auth)/signup')} style={styles.Signup}>{'Sign up'}</Text>
            </View>
        </View>
        </View>
      </ScrollView>
